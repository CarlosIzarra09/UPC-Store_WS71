...
INSERT INTO tbl_customers (id,number_id,first_name,last_name , email, photo_url, region_id, state) VALUES(1,'32404580', 'Daniel', 'Mendoza', 'profesor@upc.edu.pe','',1,'CREATED');
INSERT INTO tbl_customers (id,number_id,first_name,last_name , email, photo_url, region_id, state) VALUES(2,'32404598', 'Stefano', 'Andrade', 'vandrade@upc.edu.pe','',1,'CREATED');